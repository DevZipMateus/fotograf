        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-4">
              <a href="https://www.instagram.com/fotografcomunicacaovisual/" target="_blank" rel="noopener noreferrer" className="h-10 w-10 flex items-center justify-center rounded-full bg-blue-600 hover:bg-blue-700 transition-colors duration-200" aria-label="Instagram">
                <Instagram size={18} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <span className="text-slate-300">Avenida Santo Antônio, 380<br />Chapecó - SC</span>
              </div>
              <div className="flex items-center">
                <Phone className="mr-2 h-5 w-5 text-blue-400 flex-shrink-0" />
                <a href="tel:+5549988054778" className="text-slate-300 hover:text-white transition-colors duration-200">
                  (49) 98805-4778
                </a>
              </div>
              <div className="flex items-center">
                <Mail className="mr-2 h-5 w-5 text-blue-400 flex-shrink-0" />
                <a href="mailto:fotografcv@hotmail.com" className="text-slate-300 hover:text-white transition-colors duration-200">
